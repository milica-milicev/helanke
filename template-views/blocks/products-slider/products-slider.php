            ...
            for ($i = 1; $i <= 5; $i++) :
                ...
                if ($product_post) :
                    ...
                    <div class="product-slider__item swiper-slide">
                        <div class="product-slider__item-wrap">
                            <a href="<?php echo $product_link; ?>" class="product-slider__item-link">
                                <div class="product-slider__img-wrapper">
                                    ...
                                    <?php if ($product_hover && isset($product_hover['url'])): ?>
                                        <img class="product-slider__img hover-img" src="<?php echo $product_hover['url']; ?>" alt="<?php echo $product_hover['alt']; ?>">
                                    <?php endif; ?>
                            ...
                            <div class="product-icons">
                                <div class="product-icons__wrap">
                                    ...
                                    <a href="javascript:;">
                                        <img class="add-to-cart-icon" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/_demo/cart.svg" alt="Add to Cart">
                        ...
                        <h2 class="product-slider__item-title"><a href="#"><?php echo $product_title; ?></a></h2>
